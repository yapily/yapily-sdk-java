...
public class EmbeddedAccountsApiTest {
    ...
    public void initiateEmbeddedAccountRequestUsingPOSTTest() throws ApiException {
        ...
        ApiResponseOfAuthorisationEmbeddedRequestResponse response = api.initiateEmbeddedAccountRequestUsingPOST(accountAuthRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void updateEmbeddedAccountRequestUsingPUTTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfAuthorisationEmbeddedRequestResponse response = api.updateEmbeddedAccountRequestUsingPUT(consentId, accountAuthRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
