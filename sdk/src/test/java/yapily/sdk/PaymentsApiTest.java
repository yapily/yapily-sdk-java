...
public class PaymentsApiTest {
    ...
    public void createBulkPaymentAuthorisationUsingPOSTTest() throws ApiException {
        ...
        ApiResponseOfPaymentAuthorisationRequestResponse response = api.createBulkPaymentAuthorisationUsingPOST(paymentAuthRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void createBulkPaymentUsingPOSTTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfPaymentResponse response = api.createBulkPaymentUsingPOST(consent, paymentRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void createPaymentAuthorisationUsingPOSTTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfPaymentAuthorisationRequestResponse response = api.createPaymentAuthorisationUsingPOST(paymentAuthRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void createPaymentAuthorisationWithSortCodeUsingPOSTTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfAuthorisationRequestResponse response = api.createPaymentAuthorisationWithSortCodeUsingPOST(paymentAuthRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void createPaymentUsingPOSTTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfPaymentResponse response = api.createPaymentUsingPOST(consent, paymentRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void createPaymentWithSortCodeUsingPOSTTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfPaymentResponse response = api.createPaymentWithSortCodeUsingPOST(consent, paymentRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void getPaymentStatusUsingGETTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfPaymentResponse response = api.getPaymentStatusUsingGET(paymentId, consent, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void getPaymentsUsingGETTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfPaymentResponses response = api.getPaymentsUsingGET(paymentId, consent, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
    ...
    public void updatePaymentAuthorisationUsingPUTTest() throws ApiException {
        ...
        String psuCorporateId = null;
        String psuIpAddress = null;
        ApiResponseOfPaymentAuthorisationRequestResponse response = api.updatePaymentAuthorisationUsingPUT(consent, paymentAuthRequest, xYapilyApiVersion, psuId, psuCorporateId, psuIpAddress);
