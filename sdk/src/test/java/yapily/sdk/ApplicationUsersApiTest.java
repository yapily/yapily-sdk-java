...
public class ApplicationUsersApiTest {
    ...
    public void addUserUsingPOSTTest() throws ApiException {
        ...
        ApplicationUser response = api.addUserUsingPOST(newApplicationUser, xYapilyApiVersion);
    ...
    public void deleteUserUsingDELETETest() throws ApiException {
        ...
        String xYapilyApiVersion = null;
        ApiResponseOfUserDeleteResponse response = api.deleteUserUsingDELETE(userUuid, xYapilyApiVersion);
    ...
    public void getUserUsingGETTest() throws ApiException {
        String userUuid = null;
        String xYapilyApiVersion = null;
        ApplicationUser response = api.getUserUsingGET(userUuid, xYapilyApiVersion);
    ...
    public void getUsersUsingGETTest() throws ApiException {
        ...
        List<ApplicationUser> response = api.getUsersUsingGET(xYapilyApiVersion, filterApplicationUserId);
