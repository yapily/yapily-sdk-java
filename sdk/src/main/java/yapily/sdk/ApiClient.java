...
import yapily.sdk.auth.Authentication;
import yapily.sdk.auth.HttpBasicAuth;
import yapily.sdk.auth.HttpBearerAuth;
import yapily.sdk.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("OpenAPI-Generator/1.408.0/java");
