...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-08-13T15:50:52.806Z")
public class ApplicationsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public Object getJwksUsingGET() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/jwks";
   ...
   * @throws ApiException if fails to make API call
   */
  public ResponseEntity revokeTokensUsingPOST() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/revoke-tokens";
