...
@ApiModel(description = "The request body containing the `ConsentAuthCodeRequest` json payload")
    @JsonPropertyOrder({
        ConsentAuthCodeRequest.JSON_PROPERTY_AUTH_CODE,
        ConsentAuthCodeRequest.JSON_PROPERTY_AUTH_STATE
    })
...
public class ConsentAuthCodeRequest {
    ...
    public static final String JSON_PROPERTY_AUTH_STATE = "authState";
