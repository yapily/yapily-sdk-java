...
@ApiModel(description = "A Balance Prediction profile for a User.")
    @JsonPropertyOrder({
        BalancePredictionProfile.JSON_PROPERTY_STATUS,
        BalancePredictionProfile.JSON_PROPERTY_PROFILE_CONSENTS,
        BalancePredictionProfile.JSON_PROPERTY_ENRICHED_BALANCES
    })
...
public class BalancePredictionProfile {
    ...
    public static final String JSON_PROPERTY_ENRICHED_BALANCES = "enrichedBalances";
    @JsonProperty("enrichedBalances")
    @lombok.Singular("enrichedBalances") private List<EnrichedBalances> enrichedBalances;
