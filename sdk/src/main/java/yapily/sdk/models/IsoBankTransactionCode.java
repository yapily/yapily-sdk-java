...
*/
    @JsonPropertyOrder({
        IsoBankTransactionCode.JSON_PROPERTY_DOMAIN_CODE,
        IsoBankTransactionCode.JSON_PROPERTY_FAMILY_CODE,
        IsoBankTransactionCode.JSON_PROPERTY_SUB_FAMILY_CODE
    })
...
public class IsoBankTransactionCode {
    ...
    public static final String JSON_PROPERTY_FAMILY_CODE = "familyCode";
    @JsonProperty("familyCode")
    private IsoCodeDetails familyCode;

    public static final String JSON_PROPERTY_SUB_FAMILY_CODE = "subFamilyCode";
