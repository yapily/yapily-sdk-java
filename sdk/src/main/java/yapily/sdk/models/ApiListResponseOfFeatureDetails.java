...
import yapily.sdk.models.FeatureDetails;
import yapily.sdk.models.FilteredClientPayloadListFeatureDetails;
...
*/
    @JsonPropertyOrder({
        ApiListResponseOfFeatureDetails.JSON_PROPERTY_META,
        ApiListResponseOfFeatureDetails.JSON_PROPERTY_DATA,
        ApiListResponseOfFeatureDetails.JSON_PROPERTY_LINKS,
        ApiListResponseOfFeatureDetails.JSON_PROPERTY_FORWARDED_DATA,
        ApiListResponseOfFeatureDetails.JSON_PROPERTY_RAW,
        ApiListResponseOfFeatureDetails.JSON_PROPERTY_PAGING,
        ApiListResponseOfFeatureDetails.JSON_PROPERTY_TRACING_ID
    })
...
public class ApiListResponseOfFeatureDetails {
    ...
    @JsonProperty("data")
    @lombok.Singular("data") private List<FeatureDetails> data;
    ...
    @JsonProperty("paging")
    private FilteredClientPayloadListFeatureDetails paging;
