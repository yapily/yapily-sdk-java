...
@ApiModel(description = "__Mandatory__. Defines the intervals at which payment should be made.")
    @JsonPropertyOrder({
        FrequencyRequest.JSON_PROPERTY_TYPE,
        FrequencyRequest.JSON_PROPERTY_INTERVAL_WEEK,
        FrequencyRequest.JSON_PROPERTY_INTERVAL_MONTH,
        FrequencyRequest.JSON_PROPERTY_EXECUTION_DAY
    })
