...
import yapily.sdk.models.FilteredClientPayloadListPaymentResponse;
...
*/
    @JsonPropertyOrder({
        ApiListResponseOfPaymentResponse.JSON_PROPERTY_META,
        ApiListResponseOfPaymentResponse.JSON_PROPERTY_DATA,
        ApiListResponseOfPaymentResponse.JSON_PROPERTY_LINKS,
        ApiListResponseOfPaymentResponse.JSON_PROPERTY_FORWARDED_DATA,
        ApiListResponseOfPaymentResponse.JSON_PROPERTY_RAW,
        ApiListResponseOfPaymentResponse.JSON_PROPERTY_PAGING,
        ApiListResponseOfPaymentResponse.JSON_PROPERTY_TRACING_ID
    })
...
public class ApiListResponseOfPaymentResponse {
    ...
    @JsonProperty("data")
    @lombok.Singular("data") private List<PaymentResponse> data;
    ...
    @JsonProperty("paging")
    private FilteredClientPayloadListPaymentResponse paging;
