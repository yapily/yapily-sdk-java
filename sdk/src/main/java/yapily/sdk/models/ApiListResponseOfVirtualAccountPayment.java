...
*/
    @JsonPropertyOrder({
        ApiListResponseOfVirtualAccountPayment.JSON_PROPERTY_META,
        ApiListResponseOfVirtualAccountPayment.JSON_PROPERTY_LINKS,
        ApiListResponseOfVirtualAccountPayment.JSON_PROPERTY_DATA,
        ApiListResponseOfVirtualAccountPayment.JSON_PROPERTY_FORWARDED_DATA,
        ApiListResponseOfVirtualAccountPayment.JSON_PROPERTY_TRACING_ID
    })
...
public class ApiListResponseOfVirtualAccountPayment {
    ...
    @JsonProperty("data")
    @lombok.Singular("data") private List<VirtualAccountPayment> data;
