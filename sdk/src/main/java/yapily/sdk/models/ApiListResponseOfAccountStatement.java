...
import yapily.sdk.models.FilteredClientPayloadListAccountStatement;
...
*/
    @JsonPropertyOrder({
        ApiListResponseOfAccountStatement.JSON_PROPERTY_META,
        ApiListResponseOfAccountStatement.JSON_PROPERTY_DATA,
        ApiListResponseOfAccountStatement.JSON_PROPERTY_LINKS,
        ApiListResponseOfAccountStatement.JSON_PROPERTY_FORWARDED_DATA,
        ApiListResponseOfAccountStatement.JSON_PROPERTY_RAW,
        ApiListResponseOfAccountStatement.JSON_PROPERTY_PAGING,
        ApiListResponseOfAccountStatement.JSON_PROPERTY_TRACING_ID
    })
...
public class ApiListResponseOfAccountStatement {
    ...
    @JsonProperty("data")
    @lombok.Singular("data") private List<AccountStatement> data;
    ...
    @JsonProperty("paging")
    private FilteredClientPayloadListAccountStatement paging;
