...
@ApiModel(description = "__Optional__. Used to provide details on the currency exchange rate and contract.")
    @JsonPropertyOrder({
        ExchangeRateInformation.JSON_PROPERTY_UNIT_CURRENCY,
        ExchangeRateInformation.JSON_PROPERTY_RATE,
        ExchangeRateInformation.JSON_PROPERTY_RATE_TYPE,
        ExchangeRateInformation.JSON_PROPERTY_FOREIGN_EXCHANGE_CONTRACT_REFERENCE
    })
