...
*/
    @JsonPropertyOrder({
        ApiResponseOfPaymentAuthorisationRequestResponse.JSON_PROPERTY_META,
        ApiResponseOfPaymentAuthorisationRequestResponse.JSON_PROPERTY_DATA,
        ApiResponseOfPaymentAuthorisationRequestResponse.JSON_PROPERTY_LINKS,
        ApiResponseOfPaymentAuthorisationRequestResponse.JSON_PROPERTY_FORWARDED_DATA,
        ApiResponseOfPaymentAuthorisationRequestResponse.JSON_PROPERTY_RAW,
        ApiResponseOfPaymentAuthorisationRequestResponse.JSON_PROPERTY_TRACING_ID
    })
...
public class ApiResponseOfPaymentAuthorisationRequestResponse {
    ...
    @JsonProperty("data")
    private PaymentAuthorisationRequestResponse data;
