...
*/
    @JsonPropertyOrder({
        ...
        AccountAuthorisationResponse.JSON_PROPERTY_LAST_CONFIRMED_AT,
        AccountAuthorisationResponse.JSON_PROPERTY_RECONFIRM_BY,
...
public class AccountAuthorisationResponse {
    ...
    public static final String JSON_PROPERTY_LAST_CONFIRMED_AT = "lastConfirmedAt";
    @JsonProperty("lastConfirmedAt")
    private OffsetDateTime lastConfirmedAt;

    public static final String JSON_PROPERTY_RECONFIRM_BY = "reconfirmBy";
    @JsonProperty("reconfirmBy")
