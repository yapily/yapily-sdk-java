...
*/
    @JsonPropertyOrder({
        ApiListResponseOfVirtualAccountBeneficiary.JSON_PROPERTY_META,
        ApiListResponseOfVirtualAccountBeneficiary.JSON_PROPERTY_LINKS,
        ApiListResponseOfVirtualAccountBeneficiary.JSON_PROPERTY_DATA,
        ApiListResponseOfVirtualAccountBeneficiary.JSON_PROPERTY_FORWARDED_DATA,
        ApiListResponseOfVirtualAccountBeneficiary.JSON_PROPERTY_TRACING_ID
    })
...
public class ApiListResponseOfVirtualAccountBeneficiary {
    ...
    @JsonProperty("data")
    @lombok.Singular("data") private List<VirtualAccountBeneficiary> data;
