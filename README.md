# Yapily Java SDK
[![GitHub version](https://d25lcipzij17d.cloudfront.net/badge.svg?id=gh&type=6&v=1.232.0&x2=0)](http://badge.fury.io/gh/boennemann%2Fbadges)
...
```groovy
compile group: 'yapily', name: 'yapily-sdk', version: '1.232.0'
```
